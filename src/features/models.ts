...
export type VercelEnvironnmentGetAllResponse =
	| VercelEnvironmentInformation
	| { envs: VercelEnvironmentInformation[]; pagination: Pagination }
	| { envs: VercelEnvironmentInformation[] };

export type VercelEnvironnmentEditResponse = VercelEnvironmentInformation;

export type VercelEnvironmentCreateResponse =
	| VercelEnvironmentInformation[]
	| VercelEnvironmentInformation;

export type VercelEnvironnmentRemoveResponse = VercelEnvironmentCreateResponse;

/** @memberof VercelProjectInformationResponse */
...
export type VercelProjectInformationResponse = {
	accountId: string;
...
export interface VercelAuthUser {
